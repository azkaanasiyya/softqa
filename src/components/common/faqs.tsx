...
export default function FAQs() {
    return (
        <div className="bg-primary-50 bg-[url('/line.png')] bg-no-repeat bg-center bg-[length:1192px_auto] py-12 md:py-20 lg:py-[116px] px-8 lg:px-[124px] flex flex-col justify-center items-center">
