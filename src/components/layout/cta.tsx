...
export default function CTA() {
    return (
        <div className="bg-primary-900 flex flex-col items-center justify-center">
            <div className="max-w-[1440px] flex flex-row gap-8 pl-[128px] items-center justify-center overflow-visible">
                ...
                <Image src="/cta/img-desktop.png" alt="cta" width={704} height={484} className="w-[704px] h-[484px] object-cover object-left-top overflow-visible" />
            </div>
        </div>
    )
}