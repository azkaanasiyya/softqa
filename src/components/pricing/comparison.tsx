...
export default function PricingComparison() {
    return (
        <div className="bg-[url('/pricing/bg-comparison.png')] bg-no-repeat bg-center bg-cover flex flex-col justify-center items-center py-[104px] px-[124px]">
            <div className="max-w-[1192px] flex flex-row">
                <div className="flex flex-col w-[381px]">
                ...
                <div className="bg-base-white flex flex-col w-[270.33px]">
