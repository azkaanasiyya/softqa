    ...
    return (
        <div className="bg-base-white lg:bg-[url('/line.png')] bg-no-repeat bg-center bg-[length:1192px_auto] flex flex-col justify-center items-center py-12 md:py-16 lg:py-[104px] px-6 md:px-8 lg:px-[124px]">
            <FadeInSection delay={0.5} className="max-w-[1192px] w-full flex lg:flex-row flex-col items-center lg:items-start gap-8 lg:gap-0">
                ...
                <div className="bg-base-white hidden lg:flex lg:flex-col lg:max-w-[180px] xl:max-w-[270.33px]">
                    ...
                    <div className="border-b border-l border-grayscale-100 rounded-bl-[16px] h-[96px] py-6 px-5 flex flex-col justify-center items-center">
                        <Link href="/auth/sign-up" className="w-full block">
                            <Button variant="login" size="medium" className="cursor-pointer text-primary-500 w-full xl:w-[230.33px]">Get Started</Button>
                        </Link>
                    </div>
                </div>
                <div className="bg-base-white hidden lg:flex lg:flex-col lg:max-w-[180px] xl:max-w-[270.33px]">
                    ...
                    <div className="bg-grayscale-50 border-b border-l border-grayscale-100 h-[96px] py-6 px-5 flex flex-col justify-center items-center">
                        <Link href="/auth/sign-up" className="w-full block">
                            <Button variant="request" size="medium" className="cursor-pointer text-cyan-500 w-full xl:w-[230.33px]">Get Started</Button>
                        </Link>
                    </div>
                </div>
                <div className="bg-base-white hidden lg:flex lg:flex-col lg:max-w-[180px] xl:max-w-[270.33px]">
