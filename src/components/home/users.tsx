export default function HomeUsers() {
    return (
        <div className="bg-[url('/home/bg-users.png')] bg-no-repeat bg-center bg-cover py-12 md:py-20 lg:py-[132px] px-6 md:px-9 lg:px-[124px] border-x">
            <div className="flex flex-col items-center gap-6 md:gap-4">
                <p className="text-[56px] md:text-[88px] leading-[70px] md:leading-[125%] font-normal text-center text-cyan-500">4,587,144+</p>
                <div className="flex flex-col gap-3 md:gap-2 items-center justify-center max-w-[784px]">
