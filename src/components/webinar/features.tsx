...
export default function WebinarFeatures() {
  ...
  return (
    <div className="bg-base-white bg-[url('/line.png')] bg-no-repeat bg-center bg-cover flex flex-col justify-center items-center pt-[48.49px] pb-12 md:py-16 lg:pt-[124px] lg:pb-[132px] px-6 md:px-8 lg:px-[124px]">
