        ...
        <div className="flex flex-col justify-center items-center px-6 md:px-8 lg:px-[124px] pb-12 pt-16 md:py-20 lg:pt-[104px] lg:pb-[116px] w-full">
            <div className="max-w-[1192px] flex flex-col gap-10 md:gap-12 lg:gap-20 justify-center items-center w-full">
                <div className="flex flex-col gap-8 md:gap-10 w-full max-w-[784px]">
                    <h1 className="text-[40px] md:text-[56px] leading-[50px] md:leading-[70px] text-center text-grayscale-900">How can we help?</h1>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
                    <div className="bg-grayscale-50 rounded-[16px] flex flex-col pt-1 pb-4 px-6 gap-2 max-w-[376px] w-full">
                        ...
                        <div className="flex flex-col gap-1">
                            <div className="flex flex-row justify-between items-center py-3">
                                <span className="text-[16px] md:text-[18px] leading-6 md:leading-7 text-grayscale-900">How do I create an account?</span>
                                <Image src="/help/right-gray.png" alt="icon" width={16} height={16} />
                            </div>
                            <div className="flex flex-row justify-between items-center py-3">
                                <span className="text-[16px] md:text-[18px] leading-6 md:leading-7 text-grayscale-900">How do I update my profile informa...</span>
                                <Image src="/help/right-gray.png" alt="icon" width={16} height={16} />
                            </div>
                            <div className="flex flex-row justify-between items-center py-3">
                                <span className="text-[16px] md:text-[18px] leading-6 md:leading-7 text-grayscale-900">How can I delete my account?</span>
                                <Image src="/help/right-gray.png" alt="icon" width={16} height={16} />
                            </div>
                        </div>
                    </div>
                    <div className="bg-grayscale-50 rounded-[16px] flex flex-col pt-1 pb-4 px-6 gap-2 max-w-[376px] w-full">
                        ...
                        <div className="flex flex-col gap-1">
                            <div className="flex flex-row justify-between items-center py-3">
                                <span className="text-[16px] md:text-[18px] leading-6 md:leading-7 text-grayscale-900">What payment methods are accept...</span>
                                <Image src="/help/right-gray.png" alt="icon" width={16} height={16} />
                            </div>
                            <div className="flex flex-row justify-between items-center py-3">
                                <span className="text-[16px] md:text-[18px] leading-6 md:leading-7 text-grayscale-900">How do I view my invoice?</span>
                                <Image src="/help/right-gray.png" alt="icon" width={16} height={16} />
                            </div>
                            <div className="flex flex-row justify-between items-center py-3">
                                <span className="text-[16px] md:text-[18px] leading-6 md:leading-7 text-grayscale-900">What is the refund policy?</span>
                                <Image src="/help/right-gray.png" alt="icon" width={16} height={16} />
                            </div>
                        </div>
                    </div>
                    <div className="bg-grayscale-50 rounded-[16px] flex flex-col pt-1 pb-4 px-6 gap-2 max-w-[376px] w-full">
                        ...
                        <div className="flex flex-col gap-1">
                            <div className="flex flex-row justify-between items-center py-3">
                                <span className="text-[16px] md:text-[18px] leading-6 md:leading-7 text-grayscale-900">How can I troubleshoot login issues?</span>
                                <Image src="/help/right-gray.png" alt="icon" width={16} height={16} />
                            </div>
                            <div className="flex flex-row justify-between items-center py-3">
                                <span className="text-[16px] md:text-[18px] leading-6 md:leading-7 text-grayscale-900">What should I do if the app crashes?</span>
                                <Image src="/help/right-gray.png" alt="icon" width={16} height={16} />
                            </div>
                            <div className="flex flex-row justify-between items-center py-3">
                                <span className="text-[16px] md:text-[18px] leading-6 md:leading-7 text-grayscale-900">How do I report a bug?</span>
                                <Image src="/help/right-gray.png" alt="icon" width={16} height={16} />
                            </div>
                        </div>
                    </div>
                    <div className="bg-grayscale-50 rounded-[16px] flex flex-col pt-1 pb-4 px-6 gap-2 max-w-[376px] w-full">
                        ...
                        <div className="flex flex-col gap-1">
                            <div className="flex flex-row justify-between items-center py-3">
                                <span className="text-[16px] md:text-[18px] leading-6 md:leading-7 text-grayscale-900">How do I navigate the dashboard?</span>
                                <Image src="/help/right-gray.png" alt="icon" width={16} height={16} />
                            </div>
                            <div className="flex flex-row justify-between items-center py-3">
                                <span className="text-[16px] md:text-[18px] leading-6 md:leading-7 text-grayscale-900">Where can I find tutorials?</span>
                                <Image src="/help/right-gray.png" alt="icon" width={16} height={16} />
                            </div>
                            <div className="flex flex-row justify-between items-center py-3">
                                <span className="text-[16px] md:text-[18px] leading-6 md:leading-7 text-grayscale-900">How do I set up my first project?</span>
                                <Image src="/help/right-gray.png" alt="icon" width={16} height={16} />
                            </div>
                        </div>
                    </div>
                    <div className="bg-grayscale-50 rounded-[16px] flex flex-col pt-1 pb-4 px-6 gap-2 max-w-[376px] w-full">
                        ...
                        <div className="flex flex-col gap-1">
                            <div className="flex flex-row justify-between items-center py-3">
                                <span className="text-[16px] md:text-[18px] leading-6 md:leading-7 text-grayscale-900">How do I integrate with third-party t...</span>
                                <Image src="/help/right-gray.png" alt="icon" width={16} height={16} />
                            </div>
                            <div className="flex flex-row justify-between items-center py-3">
                                <span className="text-[16px] md:text-[18px] leading-6 md:leading-7 text-grayscale-900">What automation options are availa...</span>
                                <Image src="/help/right-gray.png" alt="icon" width={16} height={16} />
                            </div>
                            <div className="flex flex-row justify-between items-center py-3">
                                <span className="text-[16px] md:text-[18px] leading-6 md:leading-7 text-grayscale-900">How can I customize my workflow?</span>
                                <Image src="/help/right-gray.png" alt="icon" width={16} height={16} />
                            </div>
                        </div>
                    </div>
                    <div className="bg-[url('/help/bg-help.png')] bg-no-repeat bg-center bg-cover max-w-[376px] w-full p-6 flex flex-col justify-between rounded-[16px]">
