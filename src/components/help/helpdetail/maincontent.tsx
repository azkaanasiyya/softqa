...
export default function MainContent() {
    return (
        <div className="flex flex-col justify-center items-center bg-base-white px-[124px] pt-[104px] pb-[116px]">
            <div className="max-w-[1192px] flex flex-row gap-8 items-start">
                <div className="flex flex-col gap-1 rounded-[16px] bg-grayscale-50 p-3 w-[376px]">
                ...
                <div className="flex flex-col gap-12 pl-12 pr-[102px] w-[784px]">
                    <div className="flex flex-col gap-6">
                        <h3 className="text-[40px] leading-[50px] text-grayscale-900">How do I create an account?</h3>
                        <div className="flex flex-col gap-3">
                            <div className="flex flex-row gap-3 items-center">
                                ...
                                <span className="text-[18px] leading-7 text-grayscale-500">From your device, go to the Google Account sign in page.</span>
                            </div>
                            <div className="flex flex-row gap-3 items-center">
                                ...
                                <span className="text-[18px] leading-7 text-grayscale-500">Click Create account.</span>
                            </div>
                            <div className="flex flex-row gap-3 items-start">
                                ...
                                <div className="flex flex-col">
                                   <span className="text-[18px] leading-7 text-grayscale-500">In the drop down, select if the account is for your:</span>
                                    <ul className="list-disc text-[18px] leading-7 text-grayscale-500 pl-7">
                                        <li>Personal use</li>
                                        <li>Child</li>
                            ...
                            <div className="flex flex-row gap-3 items-center">
                                ...
                                <span className="text-[18px] leading-7 text-grayscale-500">To set up your account, follow the steps on the screen.</span>
                            </div>
                        </div>
                        <div className="bg-primary-50 py-3 px-5 rounded-[16px] border border-primary-100">
                            <p className="text-[18px] leading-7 text-grayscale-500">
                    ...
                    <div className="flex flex-col gap-6 pt-10 border-t border-grayscale-100">
                        <h5 className="text-[24px] leading-[30px] text-grayscale-900">The username I want is taken</h5>
                        <div className="flex flex-col gap-3">
                            <span className="text-[18px] leading-7 text-grayscale-500">You can’t create a Gmail address if the username you requested is:</span>
                            <div>
                                <ul className="list-disc text-[18px] leading-7 text-grayscale-500 pl-6">
                    ...
                    <div className="bg-primary-50 flex flex-col items-center gap-4 rounded-[12px] p-6">
                        <h5 className="text-[24px] leading-[30px] text-grayscale-900">Was this article helpful?</h5>
                        <div className="flex flex-col items-center gap-2">
                            <div className="flex flex-row gap-4">
                                <div className="flex flex-row gap-2 items-center bg-base-white rounded-[8px] border-2 border-grayscale-100 px-6 py-3">
