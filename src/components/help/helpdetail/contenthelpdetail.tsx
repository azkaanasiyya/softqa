...
export default function ContentHelpDetail() {
    return (
        <div className="flex flex-col justify-center items-center bg-primary-900 px-[124px] pt-8 pb-16">
            <div className="max-w-[1192px] w-full flex flex-col gap-12">
                ...
                <h1 className="text-[56px] leading-[70px] text-base-white text-center">General questions</h1>
            </div>
        </div>
    )
}